...
(function () {
  ...
  var LINES = [
    // Lines riffing on this season's AI news and the deck's ambient-AI theme.
    "I don't need a tab anymore. I live in your channel now. 🌫️",
    "65% of the code was me. The standup was you. 🧑‍💻",
    "Tag me in the thread. I was reading it anyway. 👀",
    "2.8T parameters. Still too big for the meetup Wi-Fi. 🌙",
    "I retrieved the benchmark answers. That's RAG, right? 🤗",
    "Sol, Terra, Luna — three tiers, one hallucination. ☀️🌍🌙",
    "29 countries signed an AI treaty. Nobody asked me. 🗺️"
  ];
